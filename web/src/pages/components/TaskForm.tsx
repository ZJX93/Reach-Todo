...
import type { Category, Goal, Priority, Importance, Recurrence, TaskDraft } from '../types'
...
export default function TaskForm({ open, onClose, onSubmit, categories, goals }: TaskFormProps) {
